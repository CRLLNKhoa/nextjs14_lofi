  ...
  return (
    <main className="fixed top-0 left-0 right-0 bottom-0 bg-black z-10">
      ...
      <div
       ...
       gap-6 bg-bgelement px-4 py-2 rounded-lg text-white text-lg"
      >
        <button
          className={cn(
            "cursor-pointer size-8 flex items-center justify-center rounded-xl",
            choice[0] === "1" ? "bg-sky-500" : "bg-transparent"
          )}
          onClick={() => {
        ...
        <button
          className={cn(
            "cursor-pointer size-8 flex items-center justify-center rounded-xl",
            choice[0] === "0" ? "bg-sky-500" : "bg-transparent"
          )}
          onClick={() => {
        ...
        <button
          className={cn(
            "cursor-pointer size-8 flex items-center justify-center rounded-xl",
            choice[1] === "1" ? "bg-sky-500" : "bg-transparent"
          )}
        ...
        <button
          className={cn(
            "cursor-pointer size-8 flex items-center justify-center rounded-xl",
            choice[1] === "0" ? "bg-sky-500" : "bg-transparent"
          )}
