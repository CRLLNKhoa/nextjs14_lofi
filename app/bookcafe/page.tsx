...
export default function BookCafe() {
  const [video, setVideo] = useState("/videos/exterior-day.mp4");
  ...
  useEffect(() => {
    const handleChangeVideo = () => {
      switch (choice) {
        case "10":
          setVideo("/videos/exterior-day.mp4");
          break;
        case "00":
          setVideo("/videos/exterior-night.mp4");
          break;
      }
    };
    handleChangeVideo();
